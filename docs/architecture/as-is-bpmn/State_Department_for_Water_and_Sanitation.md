...
- **Ministry/Department/Agency (MDA):** State Department for Water and Sanitation
...
*Guidance: This section details the specific services provided by State Department for Water and Sanitation.*

#### Rural Sanitation Programme Enrollment (WAT-SAN-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Programme Systems
- **Platform:** Sanitation Systems
- **Legal Framework:** Public Health Act
- **Notes:** Household sanitation

#### Sewerage Infrastructure Development Requests (WAT-SAN-002)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Infrastructure Systems
- **Legal Framework:** Water Act
- **Notes:** Urban sanitation

#### Faecal Sludge Management Regulation (WAT-SAN-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** Sanitation Systems
- **Legal Framework:** Public Health Act
- **Notes:** Sanitation operators
