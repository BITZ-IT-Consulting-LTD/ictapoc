...
- **Ministry/Department/Agency (MDA):** State Department for Cooperatives
...
*Guidance: This section details the specific services provided by State Department for Cooperatives.*

#### Cooperative Society Registration (TRD-COP-001)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** Cooperatives Portal
- **Legal Framework:** Cooperative Societies Act
- **Notes:** Member-based entities

#### Audit and Inspection of Cooperatives (TRD-COP-002)
- **Service Type:** G2G
- **Category:** Regulatory
- **Delivery Channel:** Physical
- **Platform:** Cooperatives Systems
- **Legal Framework:** Cooperative Societies Act
- **Notes:** Governance oversight

#### Dispute Resolution for Cooperatives (TRD-COP-003)
- **Service Type:** C2G/B2G
- **Category:** Administrative
- **Delivery Channel:** Physical
- **Platform:** Cooperatives Tribunal
- **Legal Framework:** Cooperative Societies Act
- **Notes:** Member disputes
