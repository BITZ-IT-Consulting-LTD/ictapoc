...
- **Ministry/Department/Agency (MDA):** National Registration Bureau
...
*Guidance: This section details the specific services provided by National Registration Bureau.*

#### National ID Application (INT-REG-001)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
- **Legal Framework:** Registration of Persons Act
- **Notes:** Citizen-facing

#### Replacement of Lost ID (INT-REG-002)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
...
#### Correction of ID Details (INT-REG-003)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
