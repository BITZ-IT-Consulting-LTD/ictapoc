...
*Guidance: This section details the specific services provided by Cabinet Office.*

#### Cabinet Memoranda Submission and Processing (PRE-EXE-001)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Cabinet Systems
- **Legal Framework:** Constitution of Kenya
- **Notes:** Executive decision-making

#### Tracking of Cabinet Decisions (PRE-EXE-002)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Cabinet Systems
- **Legal Framework:** Executive Procedures
- **Notes:** Implementation oversight
