...
*Guidance: This section details the specific services provided by National Health Insurance Fund.*

#### NHIF Member Registration (HLT-INS-001)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** NHIF Portal
- **Legal Framework:** NHIF Act
- **Notes:** Insurance enrolment

#### NHIF Contribution Management (HLT-INS-002)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** NHIF Portal
- **Legal Framework:** NHIF Act
- **Notes:** Premium payments

#### Claims Processing and Reimbursement (HLT-INS-003)
- **Service Type:** B2G
- **Category:** Transactional
- **Delivery Channel:** Internal
- **Platform:** NHIF Systems
- **Legal Framework:** NHIF Act
- **Notes:** Facility payments
