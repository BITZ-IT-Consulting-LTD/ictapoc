...
- **Ministry/Department/Agency (MDA):** State Department for Crop Development
...
*Guidance: This section details the specific services provided by State Department for Crop Development.*

#### Farmer Registration and Profiling (AGR-CROP-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Online/Physical
- **Platform:** Farmer Registry
- **Legal Framework:** Agriculture Act
- **Notes:** Foundation registry

#### Farm Input Subsidy Enrollment (AGR-CROP-002)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Online
- **Platform:** Subsidy Systems
- **Legal Framework:** Agriculture Act
- **Notes:** Seeds fertilizer

#### Crop Production Licensing (AGR-CROP-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** Agriculture Systems
- **Legal Framework:** Agriculture Act
- **Notes:** Commercial farming

#### Crop Pest and Disease Control Services (AGR-CROP-004)
- **Service Type:** C2G/B2G
- **Category:** Service
- **Delivery Channel:** Physical
- **Platform:** Extension Services
- **Legal Framework:** Agriculture Act
- **Notes:** Extension support

#### Strategic Grain Reserve Management (AGR-FOOD-001)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Food Security Systems
- **Legal Framework:** Agriculture Act
- **Notes:** National reserves
