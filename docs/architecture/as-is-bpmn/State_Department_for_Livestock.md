...
- **Ministry/Department/Agency (MDA):** State Department for Livestock
...
*Guidance: This section details the specific services provided by State Department for Livestock.*

#### Livestock Registration and Identification (AGR-LIV-001)
- **Service Type:** C2G/B2G
- **Category:** Programme
- **Delivery Channel:** Physical/Online
- **Platform:** Livestock Systems
- **Legal Framework:** Animal Diseases Act
- **Notes:** Traceability

#### Livestock Movement Permit (AGR-LIV-002)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** Livestock Systems
- **Legal Framework:** Animal Diseases Act
- **Notes:** Disease control

#### Veterinary Inspection and Certification (AGR-LIV-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** Veterinary Systems
- **Legal Framework:** Meat Control Act
- **Notes:** Slaughter animals

#### Artificial Insemination Services (AGR-LIV-004)
- **Service Type:** C2G
- **Category:** Service
- **Delivery Channel:** Physical
- **Platform:** Extension Services
- **Legal Framework:** Agriculture Act
- **Notes:** Breeding support
