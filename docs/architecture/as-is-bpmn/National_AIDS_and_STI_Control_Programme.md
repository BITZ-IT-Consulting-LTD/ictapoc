...
- **Ministry/Department/Agency (MDA):** National AIDS and STI Control Programme
...
*Guidance: This section details the specific services provided by National AIDS and STI Control Programme.*

#### HIV Programme Enrollment (HLT-PGM-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Facility Systems
- **Platform:** Programme Systems
- **Legal Framework:** Health Act
- **Notes:** Programme-based
