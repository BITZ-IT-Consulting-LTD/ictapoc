...
*Guidance: This section details the specific services provided by State Department for Environment.*

#### Protected Area Declaration (ENV-CON-001)
- **Service Type:** G2G
...
#### Environmental Education and Awareness (ENV-CON-002)
- **Service Type:** C2G
- **Category:** Service
- **Delivery Channel:** Programme-based
- **Platform:** Outreach Programmes
- **Legal Framework:** Environmental Management and Coordination Act
