...
*Guidance: This section details the specific services provided by Kenya Revenue Authority.*

#### PIN Registration (TRE-REV-001)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** iTax
- **Legal Framework:** Kenya Revenue Authority Act
- **Notes:** Citizen and business-facing

#### Tax Return Filing (TRE-REV-002)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** iTax
- **Legal Framework:** Income Tax Act
- **Notes:** Recurring obligation

#### Tax Payment Processing (TRE-REV-003)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** iTax
- **Legal Framework:** Tax Statutes
- **Notes:** Linked to returns

#### Tax Compliance Certificates (TRE-REV-004)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** iTax
- **Legal Framework:** Tax Procedures Act
- **Notes:** Used for procurement
