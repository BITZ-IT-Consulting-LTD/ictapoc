...
*Guidance: This section details the specific services provided by Energy and Petroleum Regulatory Authority.*

#### Energy Generation Licensing (ENG-REG-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** EPRA Portal
- **Legal Framework:** Energy Act
- **Notes:** Power producers

#### Electricity Distribution Licensing (ENG-REG-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** EPRA Portal
...
#### Petroleum Import and Export Licensing (ENG-REG-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** EPRA Portal
...
#### Fuel Retail Site Licensing (ENG-REG-004)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** EPRA Portal
- **Legal Framework:** Energy Act
- **Notes:** Service stations

#### Energy Tariff Review and Approval (ENG-REG-005)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Internal
- **Platform:** EPRA Systems
- **Legal Framework:** Energy Act
