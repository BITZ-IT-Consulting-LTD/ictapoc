...
- **Ministry/Department/Agency (MDA):** Survey of Kenya
...
*Guidance: This section details the specific services provided by Survey of Kenya.*

#### Cadastral Survey Approval (LND-SUR-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** Survey Systems
- **Legal Framework:** Survey Act
- **Notes:** Land subdivision

#### Deed Plan Preparation (LND-SUR-002)
- **Service Type:** B2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Online
- **Platform:** Survey Systems
- **Legal Framework:** Survey Act
- **Notes:** Land registration support

#### Topographical Mapping Services (LND-SUR-003)
- **Service Type:** G2G/B2G
- **Category:** Service
- **Delivery Channel:** Physical/Online
- **Platform:** Survey Systems
- **Legal Framework:** Survey Act
- **Notes:** Maps and geospatial data
