...
*Guidance: This section details the specific services provided by National Irrigation Authority.*

#### Irrigation Scheme Enrollment (WAT-IRR-001)
- **Service Type:** C2G/B2G
- **Category:** Programme
- **Delivery Channel:** Physical/Online
- **Platform:** Irrigation Systems
- **Legal Framework:** Irrigation Act
- **Notes:** Smallholder schemes

#### Irrigation Infrastructure Development Approvals (WAT-IRR-002)
- **Service Type:** G2G/B2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Irrigation Systems
- **Legal Framework:** Irrigation Act
- **Notes:** Public schemes

#### Irrigation Water Allocation Management (WAT-IRR-003)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Irrigation Systems
- **Legal Framework:** Irrigation Act
- **Notes:** Water scheduling
