...
- **Ministry/Department/Agency (MDA):** State Department for Special Programmes
...
*Guidance: This section details the specific services provided by State Department for Special Programmes.*

#### Emergency Social Assistance Enrollment (PRE-SPP-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Programme Systems
- **Platform:** Special Programmes Systems
- **Legal Framework:** Executive Directives
- **Notes:** Shock response

#### Food Relief Distribution Coordination (PRE-SPP-002)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical
- **Platform:** Relief Systems
- **Legal Framework:** Executive Directives
- **Notes:** Humanitarian assistance

#### Special Cash Transfer Programmes (PRE-SPP-003)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Programme-based
- **Platform:** Payment Systems
- **Legal Framework:** Executive Directives
- **Notes:** Vulnerable groups

#### Programme Beneficiary Targeting and Validation (PRE-SPP-004)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Social Registry Systems
- **Legal Framework:** Executive Directives
- **Notes:** Eligibility management
