...
- **Ministry/Department/Agency (MDA):** Teachers Service Commission
...
*Guidance: This section details the specific services provided by Teachers Service Commission.*

#### Teacher Registration (EDU-TSC-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** TSC Portal
- **Legal Framework:** Teachers Service Commission Act
- **Notes:** Professional registration

#### Teacher Transfer Application (EDU-TSC-002)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** TSC Portal
- **Legal Framework:** Teachers Service Commission Act
- **Notes:** Employment-related

#### Teacher Promotion Processing (EDU-TSC-003)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** TSC Systems
- **Legal Framework:** Teachers Service Commission Act
- **Notes:** Career progression

#### Disciplinary Case Management (EDU-TSC-004)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** TSC Systems
- **Legal Framework:** Teachers Service Commission Act
- **Notes:** Professional discipline
