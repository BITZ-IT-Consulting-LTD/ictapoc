...
*Guidance: This section details the specific services provided by Public Procurement Regulatory Authority.*

#### Procurement Policy Guidance (TRE-PROC-001)
- **Service Type:** G2G
- **Category:** Informational
- **Delivery Channel:** Online
- **Platform:** PPRA Portal
- **Legal Framework:** Public Procurement and Asset Disposal Act
- **Notes:** Regulatory oversight

#### Registration of Procuring Entities (TRE-PROC-002)
- **Service Type:** G2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** PPRA Portal
- **Legal Framework:** Public Procurement and Asset Disposal Act
- **Notes:** Institutional registration

#### Procurement Compliance Monitoring (TRE-PROC-003)
- **Service Type:** G2G
- **Category:** Regulatory
- **Delivery Channel:** Internal
- **Platform:** PPRA Systems
- **Legal Framework:** Public Procurement and Asset Disposal Act
- **Notes:** Oversight function
