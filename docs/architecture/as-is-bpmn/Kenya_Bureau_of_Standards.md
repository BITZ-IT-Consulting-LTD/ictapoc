...
*Guidance: This section details the specific services provided by Kenya Bureau of Standards.*

#### Product Standards Certification (TRD-STD-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KEBS Portal
- **Legal Framework:** Standards Act
- **Notes:** Quality assurance

#### Import Standardization Mark Verification (TRD-STD-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KEBS Portal
- **Legal Framework:** Standards Act
- **Notes:** Import compliance

#### Market Surveillance and Enforcement (TRD-STD-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical
- **Platform:** KEBS Systems
- **Legal Framework:** Standards Act
