...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', cast=lambda v: [s.strip() for s in v.split(',')]) + ['gokservices.bitz-itc.com']
...
AUTHENTICATION_BACKENDS = [
    'service_api.backends.EmailOrUsernameModelBackend',
]
...
# Custom User Model
AUTH_USER_MODEL = 'service_api.User'
...
# Security Headers (Applicable if Django handles SSL, but Nginx is the primary)
