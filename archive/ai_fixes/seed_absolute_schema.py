...
for item in data:
    ...
    # Look for the exact service we seeded earlier based on the EXACT name generated in previous steps
    service = ServiceConfig.objects.filter(description__icontains=item["filename"]).first()
