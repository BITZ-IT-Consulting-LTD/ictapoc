...
- **Ministry/Department/Agency (MDA):** State Department for ICT
...
*Guidance: This section details the specific services provided by State Department for ICT.*

#### eCitizen Account Registration (ICT-DIG-001)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** eCitizen
- **Legal Framework:** eCitizen Legal Framework
- **Notes:** Core digital ID for services

#### Government Digital Service Onboarding (ICT-DIG-002)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Digital Government Systems
- **Legal Framework:** Executive Order on Digital Government
- **Notes:** MDAs onboarding

#### Digital Service Standards Compliance (ICT-DIG-003)
- **Service Type:** G2G
- **Category:** Regulatory
- **Delivery Channel:** Internal
- **Platform:** Digital Government Systems
- **Legal Framework:** ICT Policy and Standards
- **Notes:** Whole-of-government
