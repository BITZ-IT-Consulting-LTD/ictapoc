...
- **Ministry/Department/Agency (MDA):** Office of the Controller of Budget
...
*Guidance: This section details the specific services provided by Office of the Controller of Budget.*

#### Budget Implementation Oversight (IND-COB-001)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** COB Systems
- **Legal Framework:** Constitution of Kenya
- **Notes:** Expenditure control

#### Approval of Withdrawals from Public Funds (IND-COB-002)
- **Service Type:** G2G
- **Category:** Regulatory
- **Delivery Channel:** Internal
- **Platform:** COB Systems
- **Legal Framework:** Public Finance Management Act
- **Notes:** Exchequer control
