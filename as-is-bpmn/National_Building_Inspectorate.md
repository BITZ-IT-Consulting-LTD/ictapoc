...
- **Ministry/Department/Agency (MDA):** National Building Inspectorate
...
*Guidance: This section details the specific services provided by National Building Inspectorate.*

#### Building Compliance Inspection (HOU-BLD-001)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical
- **Platform:** Inspection Systems
- **Legal Framework:** National Building Inspectorate Act
- **Notes:** Construction oversight

#### Occupancy Certificate Issuance (HOU-BLD-002)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical
- **Platform:** Inspection Systems
- **Legal Framework:** Building Code
- **Notes:** Completion certification
