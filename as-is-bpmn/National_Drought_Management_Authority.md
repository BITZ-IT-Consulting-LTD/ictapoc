...
- **Ministry/Department/Agency (MDA):** National Drought Management Authority
...
*Guidance: This section details the specific services provided by National Drought Management Authority.*

#### Drought Monitoring and Reporting (DEV-NDMA-001)
- **Service Type:** G2G
...
#### Emergency Cash Transfer Activation (DEV-NDMA-002)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Programme-based
- **Platform:** NDMA Systems
- **Legal Framework:** NDMA Act
- **Notes:** Shock-responsive social protection

#### Humanitarian Coordination and Appeals (DEV-NDMA-003)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** NDMA Systems
- **Legal Framework:** NDMA Act
- **Notes:** Multi-agency coordination
