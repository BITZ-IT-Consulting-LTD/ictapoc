...
- **Ministry/Department/Agency (MDA):** National TB Programme
...
*Guidance: This section details the specific services provided by National TB Programme.*

#### TB Treatment and Follow-up (HLT-PGM-003)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Facility Systems
- **Platform:** Programme Systems
- **Legal Framework:** Health Act
- **Notes:** Disease-specific
