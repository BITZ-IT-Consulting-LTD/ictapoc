...
- **Ministry/Department/Agency (MDA):** Directorate of OSH
...
*Guidance: This section details the specific services provided by Directorate of OSH.*

#### Workplace Registration (LAB-OSH-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** OSH Systems
- **Legal Framework:** Occupational Safety and Health Act
- **Notes:** Employer obligation

#### OSH Training and Certification (LAB-OSH-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** OSH Systems
- **Legal Framework:** Occupational Safety and Health Act
- **Notes:** Safety officers

#### Accident Reporting and Investigation (LAB-OSH-003)
