...
- **Ministry/Department/Agency (MDA):** Civil Registration Services
...
*Guidance: This section details the specific services provided by Civil Registration Services.*

#### Birth Registration (INT-CIV-001)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
- **Legal Framework:** Births and Deaths Registration Act
- **Notes:** Civil status

#### Death Registration (INT-CIV-002)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
...
#### Issuance of Birth Certificate (INT-CIV-003)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
