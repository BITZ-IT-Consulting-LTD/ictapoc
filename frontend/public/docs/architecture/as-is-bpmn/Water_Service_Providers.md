...
- **Ministry/Department/Agency (MDA):** Water Service Providers
...
*Guidance: This section details the specific services provided by Water Service Providers.*

#### New Water Connection Application (WAT-UTIL-001)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online/Physical
- **Platform:** Utility Portals
- **Legal Framework:** Water Act
- **Notes:** Household connections

#### Water Billing and Payments (WAT-UTIL-002)
- **Service Type:** C2G/B2G
- **Category:** Transactional
...
#### Fault Reporting and Service Requests (WAT-UTIL-003)
- **Service Type:** C2G
- **Category:** Service
- **Delivery Channel:** Online/Call Center
- **Platform:** Utility Systems
- **Legal Framework:** Water Act
