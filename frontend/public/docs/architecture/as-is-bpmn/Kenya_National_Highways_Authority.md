...
*Guidance: This section details the specific services provided by Kenya National Highways Authority.*

#### Road Use Permit (TRN-RDS-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KeNHA Portal
- **Legal Framework:** Kenya Roads Act
- **Notes:** Abnormal loads

#### Abnormal Load Movement Approval (TRN-RDS-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KeNHA Portal
