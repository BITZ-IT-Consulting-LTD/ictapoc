...
- **Ministry/Department/Agency (MDA):** Directorate of Public Health
...
*Guidance: This section details the specific services provided by Directorate of Public Health.*

#### Public Health Inspection Services (HLT-PUB-001)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical
- **Platform:** County Health Offices
- **Legal Framework:** Public Health Act
- **Notes:** Premises inspection

#### Food Handler Certification (HLT-PUB-002)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Online
- **Platform:** County Systems
- **Legal Framework:** Public Health Act
- **Notes:** Occupational requirement

#### Disease Surveillance and Notification (HLT-PUB-003)
- **Service Type:** G2G
...
#### Environmental Health Licensing (HLT-PUB-004)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** County Systems
- **Legal Framework:** Public Health Act
- **Notes:** Sanitation-related
