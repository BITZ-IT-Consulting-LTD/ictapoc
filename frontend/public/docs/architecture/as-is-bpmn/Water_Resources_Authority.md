...
*Guidance: This section details the specific services provided by Water Resources Authority.*

#### Water Abstraction Permit Application (WAT-RES-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** WRA Portal
- **Legal Framework:** Water Act
- **Notes:** Surface and groundwater use

#### Water Use Permit Renewal (WAT-RES-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** WRA Portal
- **Legal Framework:** Water Act
- **Notes:** Periodic renewal

#### Water Discharge Permit (WAT-RES-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** WRA Portal
- **Legal Framework:** Water Act
- **Notes:** Effluent discharge

#### Water Works Approval (WAT-RES-004)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** WRA Portal
- **Legal Framework:** Water Act
- **Notes:** Dams boreholes intakes

#### Water Resources Data Access and Reporting (WAT-RES-005)
- **Service Type:** C2G/B2G
- **Category:** Informational
- **Delivery Channel:** Online
- **Platform:** WRA Portal
- **Legal Framework:** Water Act
- **Notes:** Hydrological data
