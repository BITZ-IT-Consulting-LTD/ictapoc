...
- **Ministry/Department/Agency (MDA):** Government Valuer
...
*Guidance: This section details the specific services provided by Government Valuer.*

#### Valuation for Stamp Duty (LND-VAL-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** Lands Systems
- **Legal Framework:** Stamp Duty Act
- **Notes:** Property transactions

#### Compulsory Acquisition Valuation (LND-VAL-002)
- **Service Type:** C2G/G2G
- **Category:** Administrative
- **Delivery Channel:** Physical
- **Platform:** Lands Systems
- **Legal Framework:** Land Act
- **Notes:** Public interest acquisitions
