...
- **Ministry/Department/Agency (MDA):** Office of the Data Protection Commissioner
...
*Guidance: This section details the specific services provided by Office of the Data Protection Commissioner.*

#### Data Controller and Processor Registration (ICT-DAT-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** ODPC Portal
- **Legal Framework:** Data Protection Act
- **Notes:** Privacy compliance

#### Data Protection Impact Assessment Review (ICT-DAT-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** ODPC Portal
- **Legal Framework:** Data Protection Act
- **Notes:** High-risk processing

#### Data Subject Complaints Handling (ICT-DAT-003)
- **Service Type:** C2G
- **Category:** Service
- **Delivery Channel:** Online/Physical
- **Platform:** ODPC Systems
- **Legal Framework:** Data Protection Act
- **Notes:** Rights enforcement
