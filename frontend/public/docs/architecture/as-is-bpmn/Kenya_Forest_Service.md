...
*Guidance: This section details the specific services provided by Kenya Forest Service.*

#### Forest Utilization Permit (ENV-FOR-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KFS Portal
- **Legal Framework:** Forest Conservation and Management Act
- **Notes:** Timber and forest products

#### Community Forest Association Registration (ENV-FOR-002)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** KFS Systems
- **Legal Framework:** Forest Conservation and Management Act
- **Notes:** Community forestry

#### Forest Plantation Establishment Approval (ENV-FOR-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Physical/Online
- **Platform:** KFS Systems
- **Legal Framework:** Forest Conservation and Management Act
- **Notes:** Commercial forestry

#### Forest Offence Prosecution Support (ENV-FOR-004)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** KFS Systems
- **Legal Framework:** Forest Conservation and Management Act
- **Notes:** Law enforcement
