...
- **Ministry/Department/Agency (MDA):** State Department for Urban Development
...
*Guidance: This section details the specific services provided by State Department for Urban Development.*

#### Urban Renewal Project Enrollment (HOU-URB-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Online
- **Platform:** Project Systems
- **Legal Framework:** Urban Areas and Cities Act
- **Notes:** Project-based

#### Slum Upgrading Programme Enrollment (HOU-URB-002)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Online
- **Platform:** Programme Systems
- **Legal Framework:** Urban Areas and Cities Act
- **Notes:** Informal settlements
