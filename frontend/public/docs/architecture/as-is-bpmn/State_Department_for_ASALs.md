...
- **Ministry/Department/Agency (MDA):** State Department for ASALs
...
*Guidance: This section details the specific services provided by State Department for ASALs.*

#### ASAL Development Programme Enrollment (DEV-ASAL-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Programme Systems
- **Platform:** ASAL Systems
- **Legal Framework:** ASAL Policy
- **Notes:** Targeted regions

#### Drought Early Warning and Response Coordination (DEV-ASAL-002)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** NDMA Systems
- **Legal Framework:** NDMA Act
- **Notes:** Disaster preparedness

#### Food Relief and Emergency Assistance (DEV-ASAL-003)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Programme Systems
- **Platform:** Relief Systems
- **Legal Framework:** Disaster Management Framework
- **Notes:** Shock response

#### Resilience and Livelihood Support Programmes (DEV-ASAL-004)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Programme-based
- **Platform:** ASAL Systems
- **Legal Framework:** ASAL Policy
- **Notes:** Community resilience
