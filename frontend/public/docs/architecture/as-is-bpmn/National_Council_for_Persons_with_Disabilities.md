...
*Guidance: This section details the specific services provided by National Council for Persons with Disabilities.*

#### Registration of Persons with Disabilities (LAB-DIS-001)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Physical/Online
- **Platform:** NCPWD Systems
- **Legal Framework:** Persons with Disabilities Act
- **Notes:** Eligibility-based

#### Disability Grants and Assistive Devices (LAB-DIS-002)
- **Service Type:** C2G
- **Category:** Programme
...
#### Tax Exemption Processing for PWDs (LAB-DIS-003)
- **Service Type:** C2G
- **Category:** Regulatory
- **Delivery Channel:** Online/Physical
- **Platform:** NCPWD/KRA
- **Legal Framework:** Persons with Disabilities Act
- **Notes:** Linked service
