...
*Guidance: This section details the specific services provided by National Social Security Fund.*

#### NSSF Member Registration (LAB-SEC-001)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** NSSF Portal
- **Legal Framework:** NSSF Act
- **Notes:** Pension enrolment

#### NSSF Contribution Management (LAB-SEC-002)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** NSSF Portal
...
#### Benefits Claims Processing (LAB-SEC-003)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Internal
- **Platform:** NSSF Systems
- **Legal Framework:** NSSF Act
