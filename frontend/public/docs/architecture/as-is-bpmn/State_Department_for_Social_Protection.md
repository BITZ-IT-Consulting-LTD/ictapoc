...
- **Ministry/Department/Agency (MDA):** State Department for Social Protection
...
*Guidance: This section details the specific services provided by State Department for Social Protection.*

#### Registration for Cash Transfer Programmes (LAB-SOC-001)
- **Service Type:** C2G
- **Category:** Programme
- **Delivery Channel:** Physical/Huduma
- **Platform:** Huduma
- **Legal Framework:** Social Assistance Act
- **Notes:** Vulnerable households

#### Cash Transfer Disbursement (LAB-SOC-002)
- **Service Type:** C2G
- **Category:** Transactional
- **Delivery Channel:** Internal
- **Platform:** Payment Systems
- **Legal Framework:** Social Assistance Act
- **Notes:** Programme payments

#### Social Registry Management (LAB-SOC-003)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Social Registry
- **Legal Framework:** Social Assistance Act
- **Notes:** Unified registry

#### Graduation and Exit Assessment (LAB-SOC-004)
- **Service Type:** C2G
- **Category:** Administrative
- **Delivery Channel:** Physical
- **Platform:** Programme Systems
- **Legal Framework:** Social Assistance Act
- **Notes:** Programme lifecycle
