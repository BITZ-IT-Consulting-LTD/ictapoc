...
- **Ministry/Department/Agency (MDA):** Directorate of Veterinary Services
...
*Guidance: This section details the specific services provided by Directorate of Veterinary Services.*

#### Animal Disease Surveillance and Reporting (AGR-VET-001)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Veterinary Systems
- **Legal Framework:** Animal Diseases Act
- **Notes:** National surveillance

#### Animal Vaccination Campaigns (AGR-VET-002)
- **Service Type:** C2G
- **Category:** Programme
...
#### Import and Export of Animals Approval (AGR-VET-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** Veterinary Systems
- **Legal Framework:** Animal Diseases Act
- **Notes:** Cross-border trade
