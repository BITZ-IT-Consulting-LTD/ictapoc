...
*Guidance: This section details the specific services provided by Kenya Maritime Authority.*

#### Seafarer Certification (TRN-MAR-001)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KMA Portal
- **Legal Framework:** Merchant Shipping Act
- **Notes:** Maritime professionals

#### Ship Registration (TRN-MAR-002)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Online
- **Platform:** KMA Portal
- **Legal Framework:** Merchant Shipping Act
- **Notes:** Vessel registration

#### Maritime Safety Compliance (TRN-MAR-003)
- **Service Type:** B2G
- **Category:** Regulatory
- **Delivery Channel:** Internal
- **Platform:** KMA Systems
- **Legal Framework:** Merchant Shipping Act
- **Notes:** Port state control
