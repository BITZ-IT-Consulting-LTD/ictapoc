...
- **Ministry/Department/Agency (MDA):** State Department for Devolution
...
*Guidance: This section details the specific services provided by State Department for Devolution.*

#### Intergovernmental Consultation and Coordination (DEV-IGR-001)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** IGR Systems
- **Legal Framework:** Intergovernmental Relations Act
- **Notes:** National–county coordination

#### Transfer of Functions Support to Counties (DEV-IGR-002)
- **Service Type:** G2G
- **Category:** Administrative
- **Delivery Channel:** Internal
- **Platform:** Devolution Systems
- **Legal Framework:** Constitution of Kenya
- **Notes:** Function transfer support

#### Conditional Grant Administration (DEV-IGR-003)
- **Service Type:** G2G
- **Category:** Transactional
- **Delivery Channel:** Internal
- **Platform:** IFMIS/Devolution Systems
- **Legal Framework:** Public Finance Management Act
- **Notes:** Grant-funded services

#### County Capacity Building Programmes (DEV-IGR-004)
- **Service Type:** G2G
- **Category:** Programme
- **Delivery Channel:** Programme-based
- **Platform:** Devolution Programmes
- **Legal Framework:** Devolution Policy
- **Notes:** Institutional strengthening
