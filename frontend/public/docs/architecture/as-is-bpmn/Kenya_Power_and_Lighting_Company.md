...
*Guidance: This section details the specific services provided by Kenya Power and Lighting Company.*

#### Electricity Connection Application (ENG-ELC-001)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** Utility Portal
- **Legal Framework:** Energy Act
- **Notes:** New connections

#### Electricity Meter Replacement (ENG-ELC-002)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** Utility Portal
- **Legal Framework:** Energy Act
- **Notes:** Meter services

#### Electricity Billing and Payments (ENG-ELC-003)
- **Service Type:** C2G/B2G
- **Category:** Transactional
- **Delivery Channel:** Online
- **Platform:** Utility Portal
...
#### Fault Reporting and Service Requests (ENG-ELC-004)
- **Service Type:** C2G
- **Category:** Service
