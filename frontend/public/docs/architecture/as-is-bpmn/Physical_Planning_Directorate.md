...
- **Ministry/Department/Agency (MDA):** Physical Planning Directorate
...
*Guidance: This section details the specific services provided by Physical Planning Directorate.*

#### Development Permission Application (LND-PLN-001)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** County/National Interface
- **Platform:** County Systems
- **Legal Framework:** Physical and Land Use Planning Act
- **Notes:** Delegated to counties

#### Change of User Approval (LND-PLN-002)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** County/National Interface
- **Platform:** County Systems
- **Legal Framework:** Physical and Land Use Planning Act
- **Notes:** Land use change

#### Subdivision Approval (LND-PLN-003)
- **Service Type:** C2G/B2G
- **Category:** Regulatory
- **Delivery Channel:** County/National Interface
- **Platform:** County Systems
- **Legal Framework:** Physical and Land Use Planning Act
- **Notes:** Land subdivision
