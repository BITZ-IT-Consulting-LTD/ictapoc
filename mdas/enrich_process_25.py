...
# Get the twenty-sixth process (index 25)
process = data['processes'][25]

# Populate fields
process['executive_summary'] = "The National Environment Management Authority (NEMA) is Kenya's principal government agency responsible for environmental management and policy implementation. Established under the Environmental Management and Coordination Act (EMCA) of 1999, its core mandate is to ensure the sustainable management of the environment and implement environmental policies to maintain standards and regulations across Kenya."
...
process['process_overview']['policy_legal_context'].append("Established under the Environmental Management and Coordination Act (EMCA) of 1999, which provides the foundational legal framework for its mandate and functions. It operates as a Semi-Autonomous Government Agency (SAGA) under the Ministry of Environment and Forestry.")
...
process['as_is_narrative'] = "(INFERRED) NEMA's operations involve coordinating various environmental management activities, enforcing environmental laws, reviewing and approving Environmental Impact Assessments (EIAs), monitoring environmental quality and compliance, promoting public awareness and education on environmental matters, advising the government on environmental policy, conducting surveys and research, and managing natural resources and pollution control."
...
process['metadata']['source_urls'] = [
    ...
    "https://pestpro.co.ke/", # Provided context
...
print("Twenty-sixth process enriched and combined_data.json updated.")
