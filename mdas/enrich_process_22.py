...
# Get the twenty-third process (index 22)
process = data['processes'][22]
...
process['process_overview']['policy_legal_context'].append("Mandate derived from Executive Order No. 2 of November 2023. Operates within the constitutional framework governing the Executive and Legislature, and relevant national legislation that guides legislative processes and inter-branch relations. (INFERRED: This forms the legal and operational context for its liaison role.)")
...
print("Twenty-third process enriched and combined_data.json updated.")
