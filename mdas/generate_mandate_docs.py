...
output_dir = '/Users/mac/ictapoc/mdas/docs_mandate'
zip_filename = '/Users/mac/ictapoc/mdas/mda_bpm_docs_mandates.zip'
...
try:
    ...
    print(f"Generating Mandate-Rich Documentation for {len(items)} MDAs...")
    ...
    for item in items:
        ...
        with open(md_file, 'w', encoding='utf-8') as f:
            ...
            f.write("### Statutory Mandate\n")
            f.write(f"{mandate_text}\n\n")
            f.write("### Legal Context\n")
            f.write(f"{legal_context}\n\n")
            f.write("---\n\n")
    ...
    print(f"Successfully generated {count} Mandate-Enriched BPM documents.")
