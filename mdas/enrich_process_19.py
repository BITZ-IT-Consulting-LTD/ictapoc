...
# Get the twentieth process (index 19)
process = data['processes'][19]

# Populate fields
process['executive_summary'] = "The State Department for Environment in Kenya operates under the Ministry of Environment, Climate Change and Forestry. It is responsible for policy and management relating to environment, climate change, and forestry, actively protecting, conserving, and sustainably managing natural resources for socio-economic development and biodiversity."
process['process_overview']['process_objective'] = "To conserve, protect, and sustainably manage the environment and natural resources; undertake climate change action, including mitigation and adaptation; implement pollution control measures; and promote forestry development to ensure a clean, healthy, and safe environment for all Kenyans."
...
print("Twentieth process enriched and combined_data.json updated.")
