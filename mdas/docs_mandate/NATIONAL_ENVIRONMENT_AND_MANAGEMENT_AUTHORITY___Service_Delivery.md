# NATIONAL ENVIRONMENT AND MANAGEMENT AUTHORITY – Service Delivery

## Cover Page
- **Ministry/Department/Agency (MDA):** NATIONAL ENVIRONMENT AND MANAGEMENT AUTHORITY
...
### Legal Context
- Established under the Environmental Management and Coordination Act (EMCA) of 1999, which provides the foundational legal framework for its mandate and functions. It operates as a Semi-Autonomous Government Agency (SAGA) under the Ministry of Environment and Forestry.
...
### Scope
- **In Scope:** End-to-end processing within NATIONAL ENVIRONMENT AND MANAGEMENT AUTHORITY.
...
- [https://pestpro.co.ke/](https://pestpro.co.ke/)
- [https://askfilo.com/](https://askfilo.com/)
