# STANDARD BPM TEMPLATE – National Defense University - Kenya

## Cover Page
- **Ministry/Department/Agency (MDA):** National Defense University - Kenya
- **Process Name:** Represents 'National Security' cluster for balanced coverage; entity type: Agency. Included as Tier 3 for light‑touch desk review/survey.
...
## Executive Summary
Represents 'National Security' cluster for balanced coverage; entity type: Agency. Included as Tier 3 for light‑touch desk review/survey.
...
### Scope
- **In Scope:** End-to-end processing within National Defense University - Kenya.
...
### Policy Context
- The National Defense University - Kenya Act; The Constitution of Kenya 2010; Data Protection Act 2019.
