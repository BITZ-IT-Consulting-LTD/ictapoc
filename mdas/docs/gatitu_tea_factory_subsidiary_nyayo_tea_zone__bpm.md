# STANDARD BPM TEMPLATE – Gatitu Tea Factory(subsidiary Nyayo Tea Zone)

## Cover Page
- **Ministry/Department/Agency (MDA):** Gatitu Tea Factory(subsidiary Nyayo Tea Zone)
...
### Scope
- **In Scope:** End-to-end processing within Gatitu Tea Factory(subsidiary Nyayo Tea Zone).
...
### Policy Context
- The Gatitu Tea Factory(subsidiary Nyayo Tea Zone) Act; The Constitution of Kenya 2010; Data Protection Act 2019.
