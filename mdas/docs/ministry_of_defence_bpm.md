# STANDARD BPM TEMPLATE – Ministry of Defence

## Cover Page
- **Ministry/Department/Agency (MDA):** Ministry of Defence
- **Process Name:** Represents 'National Security' cluster for balanced coverage; entity type: Ministry. Included as Tier 3 for light‑touch desk review/survey.
...
## Executive Summary
Represents 'National Security' cluster for balanced coverage; entity type: Ministry. Included as Tier 3 for light‑touch desk review/survey.
...
### Scope
- **In Scope:** End-to-end processing within Ministry of Defence.
...
### Policy Context
- The Ministry of Defence Act; The Constitution of Kenya 2010; Data Protection Act 2019.
