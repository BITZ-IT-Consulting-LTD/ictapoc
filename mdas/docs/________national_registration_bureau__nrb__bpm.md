# STANDARD BPM TEMPLATE – ·       NATIONAL REGISTRATION BUREAU (NRB)

## Cover Page
- **Ministry/Department/Agency (MDA):** ·       NATIONAL REGISTRATION BUREAU (NRB)
- **Process Name:** To provide policy direction and management for human resources in the public service, coordinate national and sectoral development planning, and ensure effective implementation, monitoring, and evaluation of various government initiatives, including SDGs and public investment.
...
## Process Overview
### Process Name
To provide policy direction and management for human resources in the public service, coordinate national and sectoral development planning, and ensure effective implementation, monitoring, and evaluation of various government initiatives, including SDGs and public investment.
...
### Scope
- **In Scope:** End-to-end processing within ·       NATIONAL REGISTRATION BUREAU (NRB).
...
### Policy Context
- The ·       NATIONAL REGISTRATION BUREAU (NRB) Act; The Constitution of Kenya 2010; Data Protection Act 2019.
