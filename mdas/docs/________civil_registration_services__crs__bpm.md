# STANDARD BPM TEMPLATE – ·       CIVIL REGISTRATION SERVICES (CRS)

## Cover Page
- **Ministry/Department/Agency (MDA):** ·       CIVIL REGISTRATION SERVICES (CRS)
- **Process Name:** To manage human resources in the public service by establishing/abolishing offices, appointing/disciplining public officers, promoting constitutional values, and evaluating personnel practices to ensure an efficient, ethical, and accountable public service.
