# STANDARD BPM TEMPLATE – OFFICE OF THE DATA PROTECTION COMMISIONER (ODPC)

## Cover Page
- **Ministry/Department/Agency (MDA):** OFFICE OF THE DATA PROTECTION COMMISIONER (ODPC)
- **Process Name:** To oversee and enforce the implementation of the Data Protection Act, 2019, ensuring appropriate handling of personal data, protecting the privacy of individuals, and establishing robust legal and institutional mechanisms for data protection in Kenya.
...
## Process Overview
### Process Name
To oversee and enforce the implementation of the Data Protection Act, 2019, ensuring appropriate handling of personal data, protecting the privacy of individuals, and establishing robust legal and institutional mechanisms for data protection in Kenya.
...
### Scope
- **In Scope:** End-to-end processing within OFFICE OF THE DATA PROTECTION COMMISIONER (ODPC).
...
### Policy Context
- The OFFICE OF THE DATA PROTECTION COMMISIONER (ODPC) Act; The Constitution of Kenya 2010; Data Protection Act 2019.
