# STANDARD BPM TEMPLATE – Kipchabo Tea Factory(subsidiary Nyayo Tea Zone)

## Cover Page
- **Ministry/Department/Agency (MDA):** Kipchabo Tea Factory(subsidiary Nyayo Tea Zone)
...
### Scope
- **In Scope:** End-to-end processing within Kipchabo Tea Factory(subsidiary Nyayo Tea Zone).
...
### Policy Context
- The Kipchabo Tea Factory(subsidiary Nyayo Tea Zone) Act; The Constitution of Kenya 2010; Data Protection Act 2019.
