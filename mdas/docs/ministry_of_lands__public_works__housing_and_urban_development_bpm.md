# STANDARD BPM TEMPLATE – Ministry of Lands, Public Works, Housing and Urban Development

## Cover Page
- **Ministry/Department/Agency (MDA):** Ministry of Lands, Public Works, Housing and Urban Development
- **Process Name:** Represents 'Agriculture Rural and Urban Development' cluster for balanced coverage; entity type: Ministry. Included as Tier 3 for light‑touch desk review/survey.
