# STANDARD BPM TEMPLATE – The Blue Economy and Fisheries

## Cover Page
- **Ministry/Department/Agency (MDA):** The Blue Economy and Fisheries
- **Process Name:** Represents 'Agriculture Rural and Urban Development' cluster for balanced coverage; entity type: Department. Included as Tier 3 for light‑touch desk review/survey.
...
## Executive Summary
Represents 'Agriculture Rural and Urban Development' cluster for balanced coverage; entity type: Department. Included as Tier 3 for light‑touch desk review/survey.
...
### Scope
- **In Scope:** End-to-end processing within The Blue Economy and Fisheries.
...
### Policy Context
- The The Blue Economy and Fisheries Act; The Constitution of Kenya 2010; Data Protection Act 2019.
