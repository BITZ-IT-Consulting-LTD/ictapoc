# STANDARD BPM TEMPLATE – Kenya Institute for Public Policy Research and Analysis

## Cover Page
- **Ministry/Department/Agency (MDA):** Kenya Institute for Public Policy Research and Analysis
- **Process Name:** Represents 'Macro Working Group' cluster for balanced coverage; entity type: Agency. Included as Tier 3 for light‑touch desk review/survey.
...
## Executive Summary
Represents 'Macro Working Group' cluster for balanced coverage; entity type: Agency. Included as Tier 3 for light‑touch desk review/survey.
...
### Scope
- **In Scope:** End-to-end processing within Kenya Institute for Public Policy Research and Analysis.
...
### Policy Context
- The Kenya Institute for Public Policy Research and Analysis Act; The Constitution of Kenya 2010; Data Protection Act 2019.
