# STANDARD BPM TEMPLATE – STATE DEPARTMENT OF MEDICAL SERVICES

## Cover Page
- **Ministry/Department/Agency (MDA):** STATE DEPARTMENT OF MEDICAL SERVICES
- **Process Name:** To formulate and implement medical services policy, provide curative health services, manage health policy and administration, coordinate national health referral services, develop cancer management policies, and support medical research to enhance the health and well-being of all Kenyans.
...
## Process Overview
### Process Name
To formulate and implement medical services policy, provide curative health services, manage health policy and administration, coordinate national health referral services, develop cancer management policies, and support medical research to enhance the health and well-being of all Kenyans.
...
### Scope
- **In Scope:** End-to-end processing within STATE DEPARTMENT OF MEDICAL SERVICES.
...
### Policy Context
- The STATE DEPARTMENT OF MEDICAL SERVICES Act; The Constitution of Kenya 2010; Data Protection Act 2019.
