...
try:
    ...
    for item in items:
        ...
        with open(md_file, 'w', encoding='utf-8') as f:
            ...
            # Document Control
            f.write("## Document Control & Version History\n")
            f.write("| Version | Date | Author(s) | Change Description |\n")
            f.write("|---------|------------|---------------|--------------------|\n")
            f.write(f"| 1.0 | {current_date} | OpenClaw Agent | Initial Draft Generated |\n\n")
            f.write("---\n\n")
            ...
            f.write("|-------------|------|------------------|\n")
            # Infer stakeholders from steps actors
            actors = set()
            for s in steps:
