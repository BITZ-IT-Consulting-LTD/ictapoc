...
graph TD
    ...
    subgraph KMC_Vet [KMC Vet]
        S2["KMC Vets inspect animals for health and quality (Ante-mor..."]
    end

    subgraph KMC_Weighbridge [KMC Weighbridge]
        S3["Animals are weighed to determine purchase price."]
    end

    subgraph KMC_Operations [KMC Operations]
        S4["Animals are slaughtered and processed."]
    end

    subgraph KMC_Finance [KMC Finance]
