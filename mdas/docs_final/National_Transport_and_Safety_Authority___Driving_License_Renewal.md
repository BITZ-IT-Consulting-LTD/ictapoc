...
graph TD
    ...
    subgraph Applicant [Applicant]
        ...
        S2["Applicant selects 'Driving License Renewal' service."]
        S3["Applicant chooses the renewal period (1 year or 3 years)."]
        S4["Applicant pays the renewal fee via M-Pesa or Card."]
        S6["Applicant collects the Smart DL from the selected center ..."]
    end

    subgraph System [System]
        S5["System generates a renewal slip (for Smart DL) or updates..."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
