...
graph TD
    ...
    subgraph Practitioner [Practitioner]
        S1["Practitioner logs into the KMPDC Portal (osp.kmpdc.go.ke)."]
        S2["Practitioner updates CPD (Continuous Professional Develop..."]
        S3["Practitioner applies for Annual Retention/Practice License."]
        S4["Practitioner pays the annual retention fee via M-Pesa."]
    end

    subgraph System [System]
        S5["System generates and emails the Annual Practice License."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
...
### Policy Context
- The Kenya Medical Practitioners and Dentists Council Act; The Constitution of Kenya 2010; Data Protection Act 2019.
