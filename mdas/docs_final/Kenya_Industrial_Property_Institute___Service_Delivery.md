...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant conducts a trademark search (Form TM27) to ensu..."]
        S2["Applicant files application for registration (Form TM2) a..."]
        S5["If no opposition, applicant pays registration fee."]
    end

    subgraph KIPI [KIPI]
        S3["KIPI conducts formal and substantive examination."]
        S4["If approved, the mark is advertised in the Industrial Pro..."]
