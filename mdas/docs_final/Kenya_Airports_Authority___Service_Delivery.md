...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant/Employer submits security pass application lett..."]
        S2["Applicant fills the security pass application form and at..."]
        S4["Upon approval, applicant pays the requisite fee."]
    end

    subgraph KAA_Security [KAA Security]
        S3["KAA Security conducts vetting and background checks."]
    end
