...
graph TD
    ...
    subgraph Applicant [Applicant]
        ...
        S2["Applicant submits dossier (Product sample, KEBS cert, KRA..."]
        S4["Applicant pays the licensing fee."]
    end

    subgraph NACADA_Inspector [NACADA Inspector]
        S3["NACADA conducts physical inspection of storage/premises."]
    end
