...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant applies for Standardization Mark via KEBS IMS p..."]
        S2["Applicant pays the certification fees."]
    end

    subgraph KEBS_Officer [KEBS Officer]
        S3["KEBS officers visit the factory for inspection and sample..."]
    end

    subgraph KEBS_Lab [KEBS Lab]
        S4["Samples are tested in KEBS laboratories."]
    end

    subgraph KEBS [KEBS]
        S5["Upon passing tests, the Standardization Mark Permit is is..."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
