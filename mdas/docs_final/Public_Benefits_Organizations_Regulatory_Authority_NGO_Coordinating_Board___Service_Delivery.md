...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant conducts Name Search and Reservation at NGO Board."]
        S2["Applicant submits Form 1 (Application) with Constitution ..."]
        S4["Applicant pays registration fees."]
    end

    subgraph NGO_Board [NGO Board]
        S3["NGO Board conducts background checks (National Intelligen..."]
