...
graph TD
    ...
    subgraph Seafarer [Seafarer]
        S1["Seafarer undergoes mandatory training at an approved mari..."]
        S2["Seafarer applies to KMA for Certificate of Competency (Co..."]
        S3["Seafarer undergoes medical fitness examination."]
    end

    subgraph KMA [KMA]
        S4["KMA verifies training and medical records."]
        S5["KMA conducts oral/written examination (for officers)."]
