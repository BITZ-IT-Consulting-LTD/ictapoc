...
graph TD
    ...
    subgraph Institution [Institution]
        S1["Institution applies for registration/accreditation via TV..."]
        S2["Institution conducts and submits a Self-Assessment Report."]
    end
    ...
    subgraph TVETA_Inspectors [TVETA Inspectors]
        S4["TVETA conducts physical inspection of facilities and curr..."]
    end

    subgraph TVETA_Board [TVETA Board]
        S5["TVETA Board approves accreditation and issues Certificate."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
