...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant visits a gazetted Government Hospital for asses..."]
        S3["Applicant submits report to NCPWD via eCitizen or County ..."]
    end

    subgraph MoH [MoH]
        S2["Director of Medical Services signs the assessment report."]
    end
...
### Policy Context
- The National Council for Persons With Disabilities Act; The Constitution of Kenya 2010; Data Protection Act 2019.
