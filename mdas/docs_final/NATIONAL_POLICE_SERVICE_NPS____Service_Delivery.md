...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant logs into the eCitizen portal and selects Direc..."]
        S2["Applicant selects 'Police Clearance Certificate' applicat..."]
        S3["Applicant pays the processing fee via M-Pesa."]
        S4["Applicant downloads and prints the C24 Fingerprint Form a..."]
        S5["Applicant physically visits DCI Headquarters or a Huduma ..."]
        S7["Applicant receives notification and downloads the certifi..."]
    end

    subgraph DCI_Officer [DCI Officer]
        S6["DCI officer records fingerprints and processes the check."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
