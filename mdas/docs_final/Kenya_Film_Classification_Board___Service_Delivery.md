...
graph TD
    ...
    subgraph Filmmaker [Filmmaker]
        S1["Filmmaker applies for filming license via KFCB portal."]
        S2["Filmmaker submits script/synopsis for examination."]
        S4["Filmmaker pays the classification and licensing fees."]
    end

    subgraph KFCB [KFCB]
        S3["KFCB reviews content and assigns age rating/classification."]
        S5["KFCB issues the Filming License and Classification Certif..."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
...
### Policy Context
- The Kenya Film Classification Board Act; The Constitution of Kenya 2010; Data Protection Act 2019.
