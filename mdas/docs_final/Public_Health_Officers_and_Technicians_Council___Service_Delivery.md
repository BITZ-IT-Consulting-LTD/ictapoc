# Public Health Officers and Technicians Council – Service Delivery

## Cover Page
- **Ministry/Department/Agency (MDA):** Public Health Officers and Technicians Council
...
## Executive Summary
Represents 'Helth' cluster for balanced coverage; entity type: Agency. Included as Tier 3 for light‑touch desk review/survey.
...
graph TD
    ...
    subgraph Professional [Professional]
        S1["Professional registers on the Board's Online Portal."]
        S2["Applicant uploads academic certificates and professional ..."]
        S4["Applicant pays the registration/annual retention fee."]
    end

    subgraph Board [Board]
        S3["Board Secretariat conducts verification and indexing."]
        S5["Board gazettes the member and issues the Annual Practicin..."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
...
### Scope
- **In Scope:** End-to-end processing within Public Health Officers and Technicians Council.
...
### Policy Context
- The Public Health Officers and Technicians Council Act; The Constitution of Kenya 2010; Data Protection Act 2019.
