...
graph TD
    ...
    subgraph GDC_Science_Team [GDC Science Team]
        S1["GDC conducts surface exploration and identifies drilling ..."]
    end

    subgraph GDC_Drilling [GDC Drilling]
        S2["GDC drills exploration and production wells."]
    end

    subgraph GDC_Engineers [GDC Engineers]
        S3["Wells are tested for steam viability and pressure."]
    end

    subgraph GDC [GDC]
        S4["Steam Gathering System connects wells to the power plant."]
        S5["Steam is metered and sold to KenGen/IPP for electricity g..."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
