# Pharmacy and Poisons Board – Licensing and Permitting
...
graph TD
    ...
    subgraph Importer [Importer]
        ...
        S2["Importer applies for an Import Permit and uploads the Pro..."]
        S4["Importer pays the permit fee (e.g., 2% of FOB value)."]
    end

    subgraph PPB_Officer [PPB Officer]
        S3["PPB verifies the product registration status and invoice ..."]
    end

    subgraph PPB [PPB]
        S5["PPB approves and issues the electronic Import Permit."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
...
### Policy Context
- The Pharmacy and Poisons Board Act; The Constitution of Kenya 2010; Data Protection Act 2019.
