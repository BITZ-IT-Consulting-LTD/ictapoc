...
graph TD
    ...
    subgraph Merging_Parties [Merging Parties]
        S1["Merging parties submit a merger notification to CAK."]
        S2["Parties pay the merger filing fee based on turnover."]
    end

    subgraph CAK [CAK]
        S3["CAK conducts preliminary assessment to determine if full ..."]
        S4["CAK conducts full stakeholder analysis and market testing."]
        S5["CAK issues a determination (Approval, Approval with condi..."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
