# Kenya Safari Lodges and Hotels Limited(subsidiary of KDC) – Service Delivery

## Cover Page
- **Ministry/Department/Agency (MDA):** Kenya Safari Lodges and Hotels Limited(subsidiary of KDC)
...
graph TD
    ...
    subgraph Customer [Customer]
        S1["Customer submits an order or request for goods/services."]
        S3["Customer makes payment via Bank or M-Pesa."]
        S5["Customer signs Delivery Note or Service Acceptance Form."]
    end

    subgraph Sales_Department [Sales Department]
        S2["Corporation processes the request and issues a quotation/..."]
    end

    subgraph Stores_Operations [Stores/Operations]
        S4["Corporation releases the goods or delivers the service."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
...
### Scope
- **In Scope:** End-to-end processing within Kenya Safari Lodges and Hotels Limited(subsidiary of KDC).
...
### Policy Context
- The Kenya Safari Lodges and Hotels Limited(subsidiary of KDC) Act; The Constitution of Kenya 2010; Data Protection Act 2019.
