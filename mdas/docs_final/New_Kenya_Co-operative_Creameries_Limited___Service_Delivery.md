...
graph TD
    ...
    subgraph Farmer [Farmer]
        S1["Farmer delivers milk to New KCC Cooling Plant/Collection ..."]
    end

    subgraph Quality_Clerk [Quality Clerk]
        S2["Milk is tested for quality (lactometer/alcohol test) and ..."]
    end
    ...
    subgraph Finance [Finance]
        S5["Farmer receives monthly payment based on volume and quality."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
