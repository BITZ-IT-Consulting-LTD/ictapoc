# Kenya Fisheries Service – Service Delivery
...
graph TD
    ...
    subgraph KeFS_Inspector [KeFS Inspector]
        S2["KeFS conducts vessel inspection for safety and gear compl..."]
    end

    subgraph KeFS [KeFS]
        S4["KeFS Director General approves and issues the license."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
