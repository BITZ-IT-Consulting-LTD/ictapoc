# Kenya Forestry Research Institute – Service Delivery

## Cover Page
- **Ministry/Department/Agency (MDA):** Kenya Forestry Research Institute
...
graph TD
    ...
    subgraph Researcher [Researcher]
        S1["Researcher submits research proposal/protocol to the Inst..."]
        S4["Researcher pays institutional affiliation/review fees."]
    end

    subgraph SSC [SSC]
        S2["Scientific Steering Committee (SSC) reviews scientific me..."]
    end

    subgraph ERC [ERC]
        S3["Ethics Review Committee (ERC) reviews ethical compliance."]
    end
...
### Scope
- **In Scope:** End-to-end processing within Kenya Forestry Research Institute.
...
### Policy Context
- The Kenya Forestry Research Institute Act; The Constitution of Kenya 2010; Data Protection Act 2019.
