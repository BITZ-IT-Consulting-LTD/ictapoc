...
graph TD
    ...
    subgraph Investor [Investor]
        S1["Investor submits a project proposal and application form ..."]
        S4["Investor accepts offer and pays the annual license fee."]
    end

    subgraph EPZA [EPZA]
        S2["EPZA appraises the project (investment capital, export ma..."]
...
### Policy Context
- The Export Processing Zones Authority Act; The Constitution of Kenya 2010; Data Protection Act 2019.
