...
# Source: Priority_MDAs_Justification_Matrix.md

# Priority MDAs – Justification Matrix

This document presents the prioritised list of Ministries, Departments, and Agencies (MDAs) for intervention based on the approved prioritisation model. The model assessed:

- Institutional capacity gaps (DMI and weakest pillar scores)
- Citizen/public impact and service reach
- Records volumes and transaction intensity
- Feasibility of intervention based on readiness and mandate

---

# 1. Proposed Top Priority MDAs

---

# A. LARGE MDAs (High Records Volume / High Transaction Intensity) – 8
...
# B. MEDIUM MDAs (Moderate Records Volume / Moderate–High Transactions) – 5
...
# C. SMALL MDAs (Low Records Volume / Targeted Transactions) – 5
...
| 18 | [State Department for MSMEs](./Micro_Small_and_Medium_Enterprise_Development___Service_Delivery.md) | T2 | ~1.43 | RMI | High | <10K | Medium | Business support records | Business registry modernisation |
...
|---|-----|------|-----|----------------|----------------|----------------|------------|--------------|-------------------|
| 19 | [Cabinet Affairs](./CABINET_OFFICE___Service_Delivery.md) | T2 | ~1.30 | RMI / ESMI | Medium | 10K–100K | High | Executive records | Cabinet memoranda |
...
# 3. Prioritisation Model Summary

The prioritisation model applied three core criteria:
...
- Weakest pillars:
  - Records Management Index (RMI)
  - Enterprise Systems Maturity Index (ESMI)
  - Governance & Compliance Index (GCI)

Priority given to:

- Foundational–Basic maturity MDAs
- Records-constrained institutions

---

## B. Impact (Citizen / Public Value)
...
## C. Feasibility (Implementation Readiness)
...
The prioritised MDAs represent the highest value intervention opportunities to:

- Improve citizen service delivery
- Strengthen national registries
- Enable interoperability
- Improve accountability
- Enable digital government transformation
...
![Process Flow](temp_images/786e867e34f89fff5ebe9141caab9b8c.png)
...
![Process Flow](temp_images/e111bb6e3e84228fbd224a7f1198647f.png)
...
![Process Flow](temp_images/d2eb48bfbbd8e29b0c39a8093c41bfd7.png)
...
![Process Flow](temp_images/da7d6ed780fc34340177ef201955f8f9.png)
...
![Process Flow](temp_images/98bd5f4e41a1640aa176960ed61222c1.png)
...
![Process Flow](temp_images/b847a6609e0ae43964d23480775059c8.png)
...
![Process Flow](temp_images/4fd34fc871ead0d4cbf4d5efde4e4cd2.png)
...
![Process Flow](temp_images/43d0c5194ed08b377ad0558583cd8738.png)
...
![Process Flow](temp_images/c145d95d2fb45616f09f8a22e2d8704f.png)
...
![Process Flow](temp_images/22b183743e026daa9606edee79634282.png)
...
![Process Flow](temp_images/cd23aacf5275cc19d758b8627b86a129.png)
...
![Process Flow](temp_images/2d46e4d4e7f337ef7a0a7a5dd3496087.png)
...
![Process Flow](temp_images/d6f6336832c28977ad149788fa0f0e59.png)
...
![Process Flow](temp_images/3d2f2c25c809eea6e60226021c417c5e.png)
...
![Process Flow](temp_images/6591d5626d9dde42b26cd15b1ac65b4d.png)
...
![Process Flow](temp_images/715cbbe5abef7b80e6f03be49950b44d.png)
...
![Process Flow](temp_images/d45cb0de85de943a91d8483728cc5619.png)
...
![Process Flow](temp_images/13006147ea301eab71d491de6c20f474.png)
...
![Process Flow](temp_images/db538b4b091086b093c318091fdac2da.png)
...
![Process Flow](temp_images/cbe0ebc4fc16246d5c42fdce59cd8024.png)
...
![Process Flow](temp_images/1e467a8b78b68b19b9102c8e2052dfa6.png)
...
![Process Flow](temp_images/75a926fd5df102eed4eb54bfa7687bc6.png)
...
![Process Flow](temp_images/ae799d00984dfc6495220295d5250244.png)
...
![Process Flow](temp_images/403e1cd4a84dc7370280359b51a3cf54.png)
...
![Process Flow](temp_images/bba58e4f5afda25825bab1bf05de385d.png)
...
![Process Flow](temp_images/d8624fa10a7eb4883dcbccf1627ae4ad.png)
...
# Source: PUBLIC_SERVICE_COMMISION_PSC____Service_Delivery.md

# OFFICE OF THE HEAD OF PUBLIC SERVICE – Executive Coordination

## Cover Page
- **Ministry/Department/Agency (MDA):** Executive Office of the President
- **Department:** Office of the Head of Public Service (OHPS)
- **Process Name:** Executive Coordination and Presidential Directives
- **Document Version:** 2.1
- **Date:** 2026-02-24
- **Classification:** Official
...
![Process Flow](temp_images/cd12b941915fe607a350f9908512c156.png)
...
![Process Flow](temp_images/3e4c59db721a69065547680a57ced52f.png)
...
![Process Flow](temp_images/dd7e2187ab264990789b946e3db51cde.png)
...
![Process Flow](temp_images/e502cfd994a1351ec7b2966dbe4505cb.png)
...
![Process Flow](temp_images/0c77aac837ebeab4916a3784e18cafe8.png)
...
![Process Flow](temp_images/13a3d08c17a35e28f9dea849cf321190.png)
...
![Process Flow](temp_images/f127199379c348d16e0c7a3b0cd4d6e4.png)
...
![Process Flow](temp_images/7ed6edd5c5dd6ad5dda9726372e3059b.png)
...
![Process Flow](temp_images/164fd6293f6dad524d1f4eefdd62489a.png)
...
![Process Flow](temp_images/2bfc1c81d2060786417a0f000e230d38.png)
...
![Process Flow](temp_images/8726fab2ec1b97105729bdc061a0abab.png)
...
![Process Flow](temp_images/640bd9b040c931998e0aeb567fe3233b.png)
...
## 2. TO-BE Process (BPMN 2.0 - POC v2 Aligned)
```mermaid
flowchart TD
...
![Process Flow](temp_images/d3b8a8de082bda63bab516ad21a25114.png)
...
![Process Flow](temp_images/329febfad31209aec24b8962317576b6.png)
