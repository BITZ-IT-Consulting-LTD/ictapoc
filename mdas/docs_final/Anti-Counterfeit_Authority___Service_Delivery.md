...
graph TD
    ...
    subgraph Brand_Owner [Brand Owner]
        S1["IP Right owner logs into the ACA AIMS portal."]
        S2["Applicant submits application for IPR Recordal (Form ACA 1)."]
        S3["Applicant uploads image of genuine product and trademark ..."]
        S4["Applicant pays the recordal fee."]
    end

    subgraph ACA [ACA]
        S5["ACA approves and issues the IPR Recordal Certificate."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
