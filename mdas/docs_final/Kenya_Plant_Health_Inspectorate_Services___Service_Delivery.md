...
graph TD
    ...
    subgraph Exporter [Exporter]
        S1["Exporter registers as a client on the KEPHIS ECS portal."]
        S2["Exporter applies for Phytosanitary Certificate for a spec..."]
        S5["Upon compliance, Exporter pays inspection fees."]
    end

    subgraph KEPHIS_Inspector [KEPHIS Inspector]
        S3["KEPHIS inspector inspects the consignment at the packhous..."]
    end

    subgraph KEPHIS_Lab [KEPHIS Lab]
