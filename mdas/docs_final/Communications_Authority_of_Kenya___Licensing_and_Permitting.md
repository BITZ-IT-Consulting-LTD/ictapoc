...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant creates a profile on the CA Regulatory Portal."]
        S2["Applicant submits Type Approval application with equipmen..."]
        S3["Applicant submits a sample device (if required) to CA."]
        S4["Applicant pays the Type Approval fee."]
    end

    subgraph CA [CA]
        S5["CA technical team evaluates and tests the equipment."]
