# Kenya Civil  Aviation  Authority – Service Delivery
...
graph TD
    ...
    subgraph Applicant [Applicant]
        S1["Applicant applies for a permit to import the drone (RPAS)..."]
        S3["Applicant undergoes training at an approved ATO for Remot..."]
        S4["Applicant applies for Remote Operator's Certificate (ROC)..."]
    end

    subgraph KCAA [KCAA]
        S2["KCAA inspects and registers the drone upon arrival in the..."]
        S5["KCAA issues the certificate/license upon payment of fees."]
    end
    S1 --> S2
    S2 --> S3
    S3 --> S4
